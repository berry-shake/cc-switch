...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, Pi & Oh My Pi (OMP)
...
Modern AI-powered coding relies on tools like Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, Pi, and Oh My Pi (OMP) — but each has its own configuration format. Switching API providers means manually editing JSON, YAML, TOML, or `.env` files, and there is no unified way to manage MCP and Skills across multiple tools.
...
- **One App, Ten Tools** — Manage Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, Pi, and OMP from a single interface
- **No More Manual Editing** — 50+ provider presets including AWS Bedrock, NVIDIA NIM, and community relays; just pick and switch
- **Unified MCP & Skills Management** — Manage MCP servers for Claude, Codex, Gemini, Grok Build, OpenCode, Hermes, and OMP, plus Skills across supported apps, with bidirectional sync
...
- **10 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, Pi, and OMP; copy your key and import with one click
...
- **Unified MCP panel** — Manage MCP servers across Claude, Codex, Gemini, Grok Build, OpenCode, Hermes, and OMP with bidirectional sync and Deep Link import
...
CC Switch supports ten tools: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **OpenClaw**, **Hermes**, **Pi**, and **Oh My Pi (OMP)**. Each tool has dedicated provider and configuration management.
