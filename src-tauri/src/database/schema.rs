...
impl Database {
    ...
    fn seed_model_pricing(conn: &Connection) -> Result<(), AppError> {
        let pricing_data = [
            ...
            // 2026-08-22 OpenAI Sol 促销价（至少持续到 2026-11-21）：
            // input 4 / cached input 0.40 / output 20 / cache write 5（input 的 1.25×）。
            ("gpt-5.6-sol", "GPT-5.6 Sol", "4", "20", "0.40", "5"),
            // 2026-07-30 OpenAI 降价：luna -80%、terra -20%（Fast mode 价不入表）
