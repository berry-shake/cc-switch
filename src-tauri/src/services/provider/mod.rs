...
impl ProviderService {
    ...
    pub fn list(
        ...
        match app_type {
            AppType::Pi => return pi::list(state),
            AppType::Omp => return omp::list(state),
            _ => {}
        }
    ...
    pub fn extract_common_config_snippet(
        ...
        match app_type {
            ...
            AppType::Pi | AppType::Omp | AppType::Mcode => Ok(String::new()),
        }
    }
    ...
    fn extract_credentials(
        ...
        match app_type {
            ...
            AppType::OpenClaw | AppType::Hermes | AppType::Pi | AppType::Omp | AppType::Mcode => {
