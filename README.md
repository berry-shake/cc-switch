...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, MiniMax Code, Pi & Oh My Pi (OMP)
...
Modern AI-powered coding relies on tools like Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, MiniMax Code, Pi, and Oh My Pi (OMP) — but each has its own configuration format. Switching API providers means manually editing JSON, YAML, TOML, or `.env` files, and there is no unified way to manage MCP and Skills across multiple tools.
...
- **One App, Eleven Tools** — Manage Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, MiniMax Code, Pi, and OMP from a single interface
- **No More Manual Editing** — 50+ provider presets including AWS Bedrock, NVIDIA NIM, and community relays; just pick and switch
- **Unified MCP & Skills Management** — Manage MCP servers for Claude, Codex, Gemini, Grok Build, OpenCode, Hermes, MiniMax Code, and OMP, plus Skills across supported apps, with bidirectional sync
...
- **11 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes, MiniMax Code, Pi, and OMP; copy your key and import with one click
...
- **Unified MCP panel** — Manage MCP servers across Claude, Codex, Gemini, Grok Build, OpenCode, Hermes, MiniMax Code, and OMP with bidirectional sync and Deep Link import
- **Prompts** — Markdown editor with cross-app sync (CLAUDE.md / AGENTS.md / SYSTEM.md / APPEND_SYSTEM.md / GEMINI.md) and backfill protection
- **Skills** — One-click install from GitHub repos or ZIP files, custom repository management, and isolated Pi/OMP deployment with symlink and file copy support
...
CC Switch supports eleven tools: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **OpenClaw**, **Hermes**, **MiniMax Code**, **Pi**, and **Oh My Pi (OMP)**. Each tool has dedicated provider and configuration management.
